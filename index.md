...
humandate: "Sep 30 and Oct 1, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Bjørn Bartholdy", "Kristina Hettne", "Eduard Klapwijk", "Stephanie van de Sandt", "Peter Verhaar", "Aleksandra Wilczynska"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Halford Dace", "Elviss Dvinskis", "Paolo Rossini", "Narmin Rzayeva"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://docs.google.com/document/d/1tPF-QJAx-y1JmT6GSjKzMt4QyUl_LJewz7P4cSGU02k/edit#heading=h.9bcph0pioi7h # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: "970365458207"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
